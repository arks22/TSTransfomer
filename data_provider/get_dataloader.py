...
def get_dataloader(params):
    ...
    if params['finetune']:
        finetune_dataset = TimeSeriesDataset(finetune_timeseries, finetune_labels)
    ...
    print(f'Train Data: {len(train_dataset)} | Finetune Data:{len(finetune_dataset)} | Val Data: {len(val_dataset)} | Test Data: {len(test_dataset)}')
